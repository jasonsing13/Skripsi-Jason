...
const addUPurchase_Order = `INSERT INTO public.purchase_order (po_id, tanggal_pengiriman, pengadaan_id, item_id, nama_item, quantity, status_id, create_date, create_by, modif_date, modif_by)
